module LibTreeSitterHighlightWASM

using Wasmtime

libtree_sitter_highlight = nothing

function __init__()
    global libtree_sitter_highlight = instantiate(
        read("/home/paul/Projects/TreeSitterHighlight.jl/src/tree_sitter_highlight.wasm");
        link_wasi = true,
    )
end
...
function ts_highlighter_new(highlight_names, attribute_strings, highlight_count)
    @wcall libtree_sitter_highlight.ts_highlighter_new(
...
function ts_highlighter_delete(highlighter)
    @wcall libtree_sitter_highlight.ts_highlighter_delete(
...
function ts_highlighter_add_language(
    ...
    @wcall libtree_sitter_highlight.ts_highlighter_add_language(
...
function ts_highlighter_highlight(
    ...
    @wcall libtree_sitter_highlight.ts_highlighter_highlight(
        self::Ptr{TSHighlighter},
        scope_name::Cstring,
        source_code::Cstring,
...
function ts_highlight_buffer_new()
    @wcall libtree_sitter_highlight.ts_highlight_buffer_new()::Ptr{TSHighlightBuffer}
end
...
function ts_highlight_buffer_delete(highlighter)
    @wcall libtree_sitter_highlight.ts_highlight_buffer_delete(
...
function ts_highlight_buffer_content(highlighter)
    @wcall libtree_sitter_highlight.ts_highlight_buffer_content(
        highlighter::Ptr{TSHighlightBuffer},
    )::Ptr{Cuint}
end
...
function ts_highlight_buffer_line_offsets(highlight_buffer)
    @wcall libtree_sitter_highlight.ts_highlight_buffer_line_offsets(
...
function ts_highlight_buffer_len(highlight_buffer)
    @wcall libtree_sitter_highlight.ts_highlight_buffer_len(
        highlight_buffer::Ptr{TSHighlightBuffer},
    )::Cuint
end
...
function ts_highlight_buffer_line_count(highlight_buffer)
    @wcall libtree_sitter_highlight.ts_highlight_buffer_line_count(
        highlight_buffer::Ptr{TSHighlightBuffer},
    )::Cuint
end

end # module LibTreeSitterWASM
